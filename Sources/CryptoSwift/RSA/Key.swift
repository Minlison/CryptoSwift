...
public protocol SwiftyRSAKey: class {
...
public extension SwiftyRSAKey {
    
    /// Returns a Base64 representation of the public SwiftyRSAKey.
    ///
    /// - Returns: Data of the SwiftyRSAKey, Base64-encoded
    ...
    /// Creates a public SwiftyRSAKey with a base64-encoded string.
    ///
    /// - Parameter base64String: Base64-encoded public SwiftyRSAKey data
    /// - Throws: SwiftyRSAError
    init(base64Encoded base64String: String) throws {
    ...
    /// Creates a public SwiftyRSAKey with a PEM string.
    ///
    /// - Parameter pemString: PEM-encoded public SwiftyRSAKey string
    /// - Throws: SwiftyRSAError
    init(pemEncoded pemString: String) throws {
    ...
    /// Creates a public SwiftyRSAKey with a PEM file.
    ///
    /// - Parameters:
    ...
    /// Creates a private SwiftyRSAKey with a DER file.
    ///
    /// - Parameters:
